...
<script>
    ...
    function detailProfile() {
        $.ajax({
            ...
            success: function (result) {
                if (result == null) {
                    showMessage(""Vui lòng cập nhật thông tin đầy đủ."");
                } else {
                    //Hien thi profile
        ...
        $.ajax({
            ...
            WriteLiteral(@"al(result.accessFacebook).change();
                    ...
                    if (result.isValidate == 1) {
                        $('#modalInfor_isValidate').html(`<b class=""text-success"">Đã được xác minh</b>`);
                    } else {
                        $('#modalInfor_isValidate').html(`<b class=""text-danger"">Chưa được xác minh</b>`);
                    }
                }
            },
            error: function () {
    ...
    function activeEdit(control) {
        ...
        var s = `<button type=""button"" onclick=""cancel(${");
            WriteLiteral(@"control})"" class=""btn btn-danger w-25 mr-2"">Hủy bỏ</button><button type=""button"" onclick=""update(${control})"" class=""btn btn-primary w-25"">Lưu</button>`;
    ...
    function cancel(control) {
        disable(control);
        var s = `<button type=""button"" onclick=""activeEdit(${control})"" class=""btn btn-info w-25"">Chỉnh sửa</button>`;
        $('#changeButton' + control).html(s);
    }
        ...
        switch (control) {
            ...
            case 3:
                var s = `<div class=""form-group d-flex text-left mb-2 align-items-center"">
                                <div class=""w-25 pl-2"">
                                    <label class=""my-auto"">Tên doanh nghiệp</label>
                                </div>
                                <div class=""w-50 pl-2"">
                            ...
                            <div class=""form-group d-flex text-left mb-2 align-items-center"">
                                    <div class=""w-25 pl-2"">
                                        <label class=""my-auto"">Năm bắt đầu</");
            WriteLiteral(@"label>
                                    </div>
                                    <div class=""w-50 pl-2"">
    ...
    function loadGender() {
        $.ajax({
            ...
            success: function (result) {
                var s = `<option value=""-1"" selected disable>--Giới tính--</option>`;
