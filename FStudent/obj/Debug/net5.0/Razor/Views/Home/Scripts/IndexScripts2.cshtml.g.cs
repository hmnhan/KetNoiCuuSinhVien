#pragma checksum "D:\Github\FStudent\FStudent\Views\Home\Scripts\IndexScripts2.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5d43142361190d9a1ebbe294270421dc12c6f5bd"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Home_Scripts_IndexScripts2), @"mvc.1.0.view", @"/Views/Home/Scripts/IndexScripts2.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5d43142361190d9a1ebbe294270421dc12c6f5bd", @"/Views/Home/Scripts/IndexScripts2.cshtml")]
    ...
    public class Views_Home_Scripts_IndexScripts2 : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "5d43142361190d9a1ebbe294270421dc12c6f5bd3626", async() => {
            }
            );
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "5d43142361190d9a1ebbe294270421dc12c6f5bd4742", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.PartialTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper);
...
<script>
    ...
    function getUrlActClass(pageIndex) {
        ...
        return '/api/capnhatthongti");
            WriteLiteral(@"napi/search'
            + '?pageIndex=' + pageIndex
            + '&pageSize=' + pageSize
            + filter
            + eduTypeId
 ...
 ");
    ...
    function getDetail(id) {
        $.ajax({
            ...
            success: function (result) {
                ...
                $('#modalIn");
            WriteLiteral(@"for_phoneNumber').html(profile.phoneNumber);
            ...
            WriteLiteral(@"on (result) {
                ...
                for (var i = 0; i < result.length; i++) {
                    s += `<div class=""form-group d-flex text-left mb-2 align-items-center"">
                        ...
                        <div class=""form-g");
            WriteLiteral(@"roup d-flex text-left mb-2 align-items-center"">
                            <div class=""w-25 pl-2"">
    ...
    function loadSpecializationFilter() {
        $.ajax({
            ...
            WriteLiteral(@"${result[i].name}</option>`;
                }
    ...
    function loadAcademicYearFilter() {
        ...
        $.ajax({
            type: ""GET"",
          ");
            WriteLiteral(@"  url: ""/api/capnhatthongtinapi/getay?eduTypeId="" + eduTypeId,
            success: function (result) {
                var s = `<option value=""-1"" selected>--Tất cả--</option>`;
                for (var i = 0; i < result.length; ++i) {
                    s += `<option value=""${result[i].id}"">${result[i].name}</option>`;
    ...
    $('#modalFilter_EducationType').change(function () {
        if ($('#modalFilter_EducationType').val() != -1) {
            ...
            $('#modalFilt");
            WriteLiteral(@"er_AcademicYear').attr('disabled', 'disabled');
        }
    });
